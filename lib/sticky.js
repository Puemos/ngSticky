    ...
    function($window) {
      return {
        ...
        link: function linkFn($scope, $elem, $attrs) {
          ...
          // Resize callback
          // Patch from original https://github.com/d-oliveros/ngSticky
          ...
          $scope.initSticky = function() {
            ...
            confine = typeof $attrs.confine === 'string'
              ? $attrs.confine.toLowerCase().trim()
              : 'false';
          ...
          $scope.stickElement = function() {
            ...
            $scope.cloneElement = $elem.clone();
            $scope.cloneElement.css('opacity', 0);
